# Generated by Django 3.2.13 on 2023-05-26 08:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie_deque', models.ManyToManyField(related_name='user_movies', to=settings.AUTH_USER_MODEL)),
                ('special_cards', models.ManyToManyField(related_name='favorite_movies', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='QuestionAPI',
